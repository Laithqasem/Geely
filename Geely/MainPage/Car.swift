...
let Cars: [Car] = [
    ...
    Car(CarPhoto: UIImage(named: "dummy_car_img")!, CarName: "Geometry C",CarModel: "333", CarNumber: "51-984-74", NumberOfNotification: 2, KmLeft: 44, BatteryRemaining: 80,timeLeft: "11:23",Services: services2, Id: 1),
